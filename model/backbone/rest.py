...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=16, in_ch=3, out_ch=768, with_pos=False):
        super().__init__()
        self.patch_size = (2, 1)
        self.conv = nn.Conv2d(in_ch, out_ch, kernel_size=patch_size + 1, stride=(2, 1), padding=patch_size // 2)
...
class ResT(nn.Module):
    def __init__(self, cfg, in_chans=3, num_classes=1000, embed_dims=[3, 128, 256, 512],
